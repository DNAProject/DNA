...
var (
	...
	deployableNative = []common.Address{GasContractAddress, DIDContractAddress, ParamContractAddress, AuthContractAddress}
)
...
func IsNativeDeployable(addr common.Address) bool {
	for _, nativeAddr := range deployableNative {
		if nativeAddr == addr {
			return true
		}
	}
