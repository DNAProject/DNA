...
func TestOpBigInt(t *testing.T) {
	...
	t.Log("1 sal result 2, execute result:", engine.evaluationStack.Peek(0).GetStackItem().GetBigInteger())
	...
	t.Log("2 sar result 1, execute result:", engine.evaluationStack.Peek(0).GetStackItem().GetBigInteger())
