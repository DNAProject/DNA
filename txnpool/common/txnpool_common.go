...
const (
	MAX_CAPACITY     = 3001400                          // The tx pool's capacity that holds the verified txs
	MAX_PENDING_TXN  = 4096 * 200                       // The max length of pending txs
	MAX_WORKER_NUM   = 6                                // The max concurrent workers
	...
	MAX_LIMITATION   = 1000000                          // The length of pending tx from net and http
